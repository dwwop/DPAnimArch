...
{ 
    ...
    public void SetColor()
    {
        ...
        {
            Animation.Instance.classColor = ToolManager.Instance.SelectedColor;
            SetButtonColor(classPreset, ToolManager.Instance.SelectedColor);
        }
        if (SelectedPreset.Equals("method"))
        {
            Animation.Instance.methodColor = ToolManager.Instance.SelectedColor;
            SetButtonColor(methodPreset, ToolManager.Instance.SelectedColor);
        }
        if (SelectedPreset.Equals("relation"))
        {
            Animation.Instance.relationColor = ToolManager.Instance.SelectedColor;
    ...
    public void SetColor(Color c,Color m, Color r)
    {
            ...
            Animation.Instance.classColor = c;
            SetButtonColor(methodPreset, m);
            Animation.Instance.methodColor = m;
            SetButtonColor(relationPreset, r); ;
            Animation.Instance.relationColor = r;
    }
    ...
    {
        SelectedPreset = type;
        colorInput.text = "#"+Animation.Instance.GetColorCode(type);
