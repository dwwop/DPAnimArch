...
exeCommandCall
    :   instanceHandle '.' methodName ('()' | '(' expr? (',' expr)* ')') ';'    //asi tu netreba across realtionspec
...
expr
    ...
    |   variableName '.' variableName    //tu sme nepouzili instanceHandle, nechavame to takto
...
fragment INT
    :   '0' | [1-9][0-9]*   //[0-9]+  je v ich gramatike
    ;
fragment DECIMAL
